...
gdjs.evtsExt__ButtonStates__ButtonObjectEffects.ButtonObjectEffects = class ButtonObjectEffects extends gdjs.RuntimeBehavior {
  constructor(instanceContainer, behaviorData, owner) {
    ...
    this._behaviorData.ButtonFSM = behaviorData.ButtonFSM !== undefined ? behaviorData.ButtonFSM : 0 /* Error: property was of an unrecognized type */;
    this._behaviorData.Effect = behaviorData.Effect !== undefined ? behaviorData.Effect : 0 /* Error: property was of an unrecognized type */;
  ...
  _getButtonFSM() {
    return this._behaviorData.ButtonFSM !== undefined ? this._behaviorData.ButtonFSM : 0 /* Error: property was of an unrecognized type */;
  }
  _setButtonFSM(newValue) {
    this._behaviorData.ButtonFSM = newValue;
  }
  _getEffect() {
    return this._behaviorData.Effect !== undefined ? this._behaviorData.Effect : 0 /* Error: property was of an unrecognized type */;
  }
  _setEffect(newValue) {
